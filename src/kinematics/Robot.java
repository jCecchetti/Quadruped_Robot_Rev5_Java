...
public class Robot extends Thread{
	...
	public Robot(){
		if(!Constants.SIMULATION) {
			...
			frontLeftLeg = new Leg(servoHat.getServo("S15"), servoHat.getServo("S16"), servoHat.getServo("S14"), true);
			frontRightLeg = new Leg(servoHat.getServo("S11"), servoHat.getServo("S12"), servoHat.getServo("S10"), false);
			hindLeftLeg = new Leg(servoHat.getServo("S04"), servoHat.getServo("S03"), servoHat.getServo("S02"), true);
			hindRightLeg = new Leg(servoHat.getServo("S08"), servoHat.getServo("S07"), servoHat.getServo("S06"), false);
		}
		else{
